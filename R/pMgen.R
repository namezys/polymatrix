...
{
  pa <- polyMgen.a(k=k, j=j, degree=degree, rawData=rawData, symb=symb, rand=rand)
...
polyMgen.d <- function(k=2, j=3, rawData=NULL, symb="x", rand=NULL, degree=NULL, byrow=FALSE)
{
  rows <- k
  columns <- j
